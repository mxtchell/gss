...
@skill(
    ...
    parameter_guidance="IMPORTANT: For 'globally' or 'overall' questions, do NOT add any breakout_dimension - just return the single overall value. Use sexually_active_hq4_flag (no breakout) for '% sexually active globally'. Use pct_committed_among_active (no breakout) for '% sexually active in committed relationships'. Only add breakout_dimension when user asks 'by gender', 'by country', etc.",
    parameters=[
        SkillParameter(
            name="metrics",
